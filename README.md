...
5. Make sure that the QGIS Processing plug-in and its GRASS provider are enabled in QGIS.
6. You should now find the additional "v.net.*" available as new "Algorithm" entries in the QGIS Processing Toolbox (you might have to restart QGIS first).
